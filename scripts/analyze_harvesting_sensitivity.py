...
def summarize_harvesting(manifest_path):
...
def write_harvesting_outputs(manifest_path, output_dir):
    output_dir = Path(output_dir)
    output_dir.mkdir(parents=True, exist_ok=True)
    by_seed, summary = summarize_harvesting(manifest_path)
    by_seed.to_csv(
...
def main(argv=None):
    ...
    write_harvesting_outputs(args.manifest, args.output_dir)
    print(LIMITATION)
