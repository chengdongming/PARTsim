...
VERSION='1.3.11'
ALGORITHM='SHA256_DOMAIN_SEPARATED_CANONICAL_V1_3_11'
...
'schema':'ASAP_BLOCK_experiment_schema_v1_3_11.yaml','dictionary':'ASAP_BLOCK_data_dictionary_v1_3_11.yaml',
'canonical':'ASAP_BLOCK_canonical_serialization_v1_3_11.yaml','interface_manifest':'ASAP_BLOCK_machine_interface_manifest_v1_3_11.yaml',
'formal':'ASAP_BLOCK_formal_contract_template_v1_3_11.yaml','generator':'ASAP_BLOCK_generator_contract_template_v1_3_11.yaml',
'simulation':'ASAP_BLOCK_simulation_contract_template_v1_3_11.yaml','trace':'ASAP_BLOCK_trace_generator_contract_template_v1_3_11.yaml',
'acceptance':'ASAP_BLOCK_acceptance_report_template_v1_3_11.yaml','common':'ASAP_BLOCK_validation_common_v1_3_11.py',
'artifact_validator':'ASAP_BLOCK_artifact_validator_v1_3_11.py','result_validator':'ASAP_BLOCK_result_validator_v1_3_11.py',
'acceptance_validator':'ASAP_BLOCK_acceptance_report_validator_v1_3_11.py','plan_template':'ASAP_BLOCK_run_plan_definition_template_v1_3_11.csv',
'plan_dependencies_template':'ASAP_BLOCK_run_plan_dependencies_template_v1_3_11.csv','execution_log_template':'ASAP_BLOCK_run_execution_log_template_v1_3_11.csv',
'validation_summary':'ASAP_BLOCK_v1_3_11_验证摘要.txt'}
...
def validate(root:Path,check_report=True,run_subvalidator_checks=True):
    ...
    req=set(f.get('output_contract',{}).get('required_files',[]));er={'config.yaml','generator_contract.yaml','simulation_contract.yaml','trace_generator_contract.yaml','formal_contract.yaml','acceptance_report.yaml','manifest.json','git_commit.txt','git_status.txt','sha256sum.txt','ASAP_BLOCK_validation_common_v1_3_11.py','ASAP_BLOCK_artifact_validator_v1_3_11.py','ASAP_BLOCK_result_validator_v1_3_11.py','ASAP_BLOCK_acceptance_report_validator_v1_3_11.py','ASAP_BLOCK_formal_contract_template_v1_3_11.yaml'}|set(st)|{rec.get('file') for rec in f.get('artifact_bindings',{}).values() if isinstance(rec,dict)}
...
def self_test(root):
    ...
    def bad_markdown_authority(d):
        x=d/FILES['markdown'];t=read_text_strict(x).replace('MACHINE_INTERFACE_AUTHORITY_V1_3_11','MACHINE_INTERFACE_AUTHORITY_V1_3_7',1)
