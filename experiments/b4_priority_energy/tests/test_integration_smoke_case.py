...
"""
    ...
    def test_result_parser_checks_identity_tasks_horizon_and_energy(self):
        ...
        clipped_emax_j = 0.05700355590675622
        document["events"][0]["current_energy_mJ"] = 57.0036
        real_case.validate_result_document(
            document,
            "smoke-result",
            semantic_hash,
            clipped_emax_j,
        ...
        document["events"][0]["current_energy_mJ"] = 57.0037
        with self.assertRaisesRegex(
            real_case.RealSmokeCaseError,
            "battery field outside",
        ):
            real_case.validate_result_document(
                document,
                "smoke-result",
