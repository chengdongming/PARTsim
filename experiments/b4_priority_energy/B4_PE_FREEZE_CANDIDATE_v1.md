...
| --- | --- | --- |
| Experiment document | `docs/experiments/ASAP_BLOCK_B4_priority_energy_v5_2_frozen.md` | `5e168664d9ce2062bf2418d2280195124c08b1311d1de1e280d20822965c0581` |
...
| Identity protocol | `experiments/b4_priority_energy/protocol_resolution_v1.json` | `941d754e27e1cf599127550561a14a92f46e3605df26dca3c9a97e0325eecd93` |
| Execution protocol | `experiments/b4_priority_energy/execution_protocol_v1.json` | `74fd9ed742ad41dbedb66a5e7de2bbc796e746ae2efb207d2d456deed10cdd34` |
...
## Authorized document identity migration

For the R2/master integration only, PR #58 removed two trailing spaces from
line 2 of the frozen experiment document. Its byte-exact SHA-256 therefore
changed from the historical identity
...
This migration is explicitly authorized and non-silent. It has
`semantic_change=false` and `scientific_contract_change=false`; the candidate
status and `silent_changes_forbidden=true` governance remain in force.
...
| Formal | 18000 | `5b27761ab556455dd94cfbb5c63725b16bfa126b4c38871b0b8b8d8ae801c777` |
| Negative | 5400 | `690827b07c1320da843e77f06e9dbff638c24a4af43e20d7405f6f32ff5039fb` |
