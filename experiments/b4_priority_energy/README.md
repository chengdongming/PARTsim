...
runtime evidence using only logical paths and SHA-256 identities. This
candidate binding does not authorize a campaign, establish a final commit or
tag, or designate a Formal runtime.
