...
B3_V2_TASKSET_SCHEMA = "ASAP_BLOCK_V9_3_EXT1B_B3_TARGET_TRACE_TASKSET_V6"
B3_V2_TASKSET_DOMAIN = "ASAP_BLOCK:V9.3:EXT1B:TASKSET:v6"
B3_V2_SCENARIO_CANDIDATE_DOMAIN = (
    "ASAP_BLOCK:V9.3:EXT1B:B3:SCENARIO_CANDIDATE:v3"
)
B3_V2_PAIRED_INSTANCE_DOMAIN = (
    "ASAP_BLOCK:V9.3:EXT1B:PAIRED_INSTANCE:v5"
)
