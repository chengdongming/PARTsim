...
namespace RTSim {
    ...
    constexpr int B4_OBSERVABILITY_SUMMARY_CONTRACT_VERSION_V2 = 2;
    ...
    struct MechanismSummary {
        ...
        std::uint64_t sync_batch_evaluation_ticks = 0;
        std::uint64_t sync_batch_reject_ticks = 0;
        std::uint64_t alap_deferral_opportunity_ticks = 0;
        std::uint64_t positive_slack_deferral_ticks = 0;
        std::uint64_t st_charging_opportunity_ticks = 0;
        std::uint64_t st_slack_charging_wait_ticks = 0;
    };
    ...
    struct PerTaskLifecycleSummary {
        ...
        std::uint64_t adjudicable_jobs = 0;
